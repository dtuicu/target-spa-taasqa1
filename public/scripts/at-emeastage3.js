...
(window.adobe = window.adobe || {}),
  (window.adobe.target = (function () {
    ...
    function q(e) {
      return (
        "string" == typeof e || (!g(e) && D(e) && "[object String]" === b(e))
      );
    }
    function M(e) {
      if (!q(e)) return -1;
    ...
    function Ge(e) {
      ...
      let t;
      return (
        qe() && "function" == typeof global.fetch
          ? (t = global.fetch)
          : De() &&
    ...
    function Ct(e, t, n) {
      let r = "";
      "file:" === e.location.protocol || (r = kt(e.location.hostname)),
        (n.cookieDomain = r),
        (n.enabled =
          (function (e) {
    ...
    function _t(e) {
      ...
      (It = h({}, e)),
        (It.deviceIdLifetime = e.deviceIdLifetime / 1e3),
        (It.sessionIdLifetime = e.sessionIdLifetime / 1e3),
        (It.scheme = It.secureOnly || t ? "https:" : "");
    }
    function Nt() {
      return It;
    }
    ...
    var Dt = Pt.exports,
      qt = { get: Dt.get, set: Dt.set, remove: Dt.remove },
      Mt = {};
    function jt(e, t) {
    ...
    const { parse: Vt, stringify: Ut } = Ft,
      Ht = St.createElement("a"),
      Bt = {};
    function zt(e) {
      try {
        return Vt(e);
    ...
    const { get: Zt, set: Wt, remove: Xt } = qt;
    function Yt(e, t, n) {
      return { name: e, value: t, expires: n };
    }
    function Qt(e) {
      const t = fe("#", e);
      return H(t) || t.length < 3 || isNaN(parseInt(t[2], 10))
        ? null
        : Yt(Jt(t[0]), Jt(t[1]), Number(t[2]));
    }
    function en() {
    ...
    const vn = { debug: gn, error: mn, built: !0 };
    function yn(e, t, n) {
      const r = e[wt] || [];
      if (((e[wt] = r), !n)) return;
      const o = r.push;
      (r.version = "1"),
        ...
        (r.serverTraces = []),
        (r.push = function (e) {
          r.serverTraces.push(h({ timestamp: oe() }, e)), o.call(this, e);
        });
    }
    function bn(e, t, n, r) {
      "serverTraces" === t && e[wt].push(n),
        r && "serverTraces" !== t && e[wt][t].push(h({ timestamp: oe() }, n));
    }
    function wn(e) {
    ...
    function On(e, t) {
      try {
        ...
        if (t && ("object" == typeof t || "function" == typeof t)) {
          var n = t.then;
          if (t instanceof Tn)
            return (e._state = 3), (e._value = t), void Cn(e);
    ...
    (Tn.prototype["catch"] = function (e) {
      ...
      (Tn.resolve = function (e) {
        return e && "object" == typeof e && e.constructor === Tn
          ? e
          : new Tn(function (t) {
              t(e);
            });
    ...
    var Pn = a(Object.freeze({ __proto__: null, default: Tn })),
      Dn =
      ...
      qn = (function (e) {
        var t = (function () {
          ...
          return (
              ...
              parents: function (e) {
                for (var t = [], r = this; r.length > 0; )
                  r = n.map(r, function (e) {
                    if ((e = e.parentNode) && !q(e) && t.indexOf(e) < 0)
                      return t.push(e), e;
                  });
                return z(t, e);
              },
            ...
            (O.Z.prototype = H.prototype = n.fn),
            (O.uniq = i),
    ...
    function Hn(e) {
      return g(e)
        ? Dn.all(e)
        : Un(new TypeError("Expected an array of promises"));
    }
    function Bn(e, t, n) {
      let r = -1;
      const o = Fn((e, o) => {
      ...
      g(i)
        ? Dn.race(i)
        : Un(new TypeError("Expected an array of promises"))).then(
        (e) => (pe(r), e),
        (e) => {
          throw (pe(r), e);
        }
    ...
    Dn._setImmediateFn &&
      (jn()
        ? Dn._setImmediateFn(Rn())
        : -1 !== Et.navigator.userAgent.indexOf("MSIE 10") &&
          Dn._setImmediateFn((e) => {
            let t = qn("<script>");
    ...
    function jr(e) {
      const t = (function (e) {
        ...
        return J(t) ? ((Mr = !1), null) : ((Mr = !0), { token: t });
      })(e.location.search);
      if (m(t)) return;
    ...
    function Jr(e, t) {
      ...
      Hr(
        ...
        })(e.defaultContentHiddenStyle, te(", ", t)),
        "head"
      );
    }
    function Gr() {
    ...
    function Qr(e) {
      ...
      return w(t)
        ? (function (e) {
            ...
            const t = [];
            return (
              e.nameSpaces && t.push.apply(t, Yr(e.nameSpaces, "NS")),
              e.dataSources && t.push.apply(t, Yr(e.dataSources, "DS")),
              t
            );
          })(t)
        : [];
    ...
    function Fo() {
      let e =
        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
      return ue((e, t, n) => (_o(n) || (e[n] = m(t) ? "" : t), e), {}, e);
    }
    function Vo() {
      let e =
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
    ...
    const zo = (e, t) =>
      ...
      Zo = (e, t) =>
        ...
        "'.",
      Wo = "Not Applicable",
      Xo = "Unable to read artifact JSON",
      Yo = "unknown",
      Qo = /.+\.bin$/i,
      ei = ["bin", "json"],
      ti = { bin: "rules.bin", json: "rules.json" },
      ni = {};
    (ni[Ie] = "assets.adobetarget.com"),
      (ni.staging = "assets.staging.adobetarget.com"),
      (ni.development = "assets.staging.adobetarget.com");
    const ri = "activity.id",
      oi = "activity.name",
      ii = "activity.type",
      ci = "experience.id",
      ui = "experience.name",
    ...
    function gi(e, t) {
      if (ke(e)) throw new Error($o);
      const n = Array.from(Ne("mboxes", t));
      ((t.execute && _e(t.execute.pageLoad)) ||
        (t.prefetch && _e(t.prefetch.pageLoad))) &&
    ...
    function vi(e, t) {
      const n = F(e, Oe);
      return n || Se(t).debug(Zo(e, Ie)), n ? e : Ie;
    }
    function yi(e) {
      let { cdnBasePath: t } = e;
      if (!Ce(t)) {
        const n = (function (e) {
            const { cdnEnvironment: t = Ie } = e;
            return vi(t, e.logger);
          })(e),
          r = F(n, Oe) ? n : Ie;
        t = ni[r];
      }
    ...
    function xi(e) {
      ...
      if (q(o)) return o;
      const i = (function (e) {
        const { environment: t = Ie } = e;
        return vi(t, e.logger);
      })(e);
      return [yi(e), t, i, "v1", Ce(n) ? n : void 0, bi(r)]
        .filter((e) => Ce(e))
        .join("/");
    }
    const Si = { channel: "web" };
    function Ei(e) {
      const t = {};
      return (
    ...
    function Ti(e) {
      ...
      const t = (function (e) {
        q(e) || (e = "");
        const t = tt(e) || {},
          { host: n = "", path: r = "", query: o = "", anchor: i = "" } = t,
          c = { url: e, path: r, query: o, fragment: i },
          u = n.split(".");
        switch (u.length) {
          case 1:
          ...
          case 2:
            ...
            break;
          case 3:
            (c.subdomain = "www" === u[0] ? "" : u[0]),
              (c.domain = n),
              (c.topLevelDomain = u[2]);
            break;
          case 4:
            (c.subdomain = "www" === u[0] ? "" : u[0]),
              (c.domain = n),
              (c.topLevelDomain = u[2] + "." + u[3]);
        }
        return c;
      })(e);
      return Ho(Ho({}, t), Ei(t));
    ...
    function Ci(e) {
      ...
      return Ho(
        ...
        {},
        {
          user: Ai(t),
          page: Ii(t.address),
          referring: ((n = t.address), Ti(n ? n.referringUrl : "")),
          geo: ki(t.geo || {}),
        }
      );
      var n;
    }
    const _i = (e, t) => e.order - t.order;
    function Ni(e, t) {
      let n = {};
      const r = {};
      let o = 0;
    ...
    const Pi = "mbox",
      ...
      Mi = "actions",
      ji = /\$\{([a-zA-Z0-9_.]*?)\}/gi,
      Li = { campaign: "activity", recipe: "experience" },
      Ri = new RegExp(Object.keys(Li).join("|"), "gi"),
      Fi = ["mbox"];
    function Vi(e) {
          ...
          {},
          {
            options: i.map((e, n) => {
              ...
              return (
                ...
                Ho(Ho({}, e), {}, { eventToken: r })
              );
            }),
          }
        );
      return n !== Di && delete c.metrics, c;
    }
    function Bi(e, t, n, r, o) {
      return Ho(Ho({}, t), {}, { trace: o.getTraceResult() });
    }
    ...
    function Ji(e, t, n, r, o) {
      function i(t) {
        return ke(t) || !q(t)
          ? t
          : t.replace(ji, (t, n) => {
              let o = n.replace(Ri, (e) => Li[e]).split(".");
              o.length > 2 && (o = o.slice(o.length - 2));
              const i = o.filter((e) => !F(e, Fi)).join("."),
                { parameters: c = {} } = r;
              return (function (e) {
                let t =
                    arguments.length > 1 && void 0 !== arguments[1]
    ...
    function Xi(e, t, n) {
      ...
      const o = [e, t, q(n) && !H(n) ? n : Zi(n), r].join(".");
      return Wi(o);
    }
    function Yi(e, t) {
      const n = Zi(t);
      return function (t, r, o, i, c, u) {
        let s,
          { page: a, referring: f } = r;
        Ce(i.address) && ((a = Ii(i.address) || a), (f = Ii(i.address) || f));
        const l = Ho(
            Ho({}, r),
            {},
            {
              ...
              referring: f,
              mbox: Oi(i),
              allocation: Xi(e, t.meta[ri], n),
            }
          ),
          d = Ki.apply(t.condition, l);
        return (
          u.traceRuleEvaluated(t, i, o, l, d),
          d &&
            ((s = Ho(Ho({}, t.consequence), {}, { index: i.index })),
            c.forEach((e) => {
              s = e(t, s, o, i, u);
            })),
          (function (e) {
    ...
    function ec(e, t, n, r, o, i) {
      const { responseTokens: c, rules: u } = r,
        s = r.globalMbox || "target-global-mbox",
        a = e.client,
        { request: f, visitor: l } = t,
        d = (function () {
          let e =
            arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
        ...
        { sendNotificationFunc: p, telemetryEnabled: h = !0 } = e,
        m = Yi(a, f.id),
        g = gi(r, f),
        v = (function (e, t, n) {
          let r =
          ...
          function a() {
            if (
              (n.debug("LD.NotificationProvider.sendNotifications", u),
              u.length > 0 || o)
            ) {
              const { id: n, context: o, experienceCloud: i } = e,
                c = {
                  request: { id: n, context: o, experienceCloud: i },
                  visitor: t,
                };
              u.length > 0 && (c.request.notifications = u),
                setTimeout(() => {
                  try {
                    r.call(null, c);
                  } catch (e) {
                    if (
                      "Notifications array is required in request" !== e.message
                    )
                      throw e;
                  }
                }, 0),
          ...
          return { addNotification: s, sendNotifications: a };
        })(f, l, o, p, h);
      function y(e, t) {
        if (ke(f[e])) return;
        const o = Ni(i, r);
        function c(r) {
          let i =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [];
          const c = r.name === s;
          o.traceRequest(e, Pi, r, n);
          const a = [],
            f = (u.mboxes[r.name] || []).filter(Qi(d)),
            l = new Set();
          for (const e of f) {
            const u = mi(e);
            let s;
        ...
        const a = {};
        return (
          f[e].mboxes && (a.mboxes = _(f[e].mboxes.map((e) => c(e)))),
          f[e].views &&
            (a.views = _(
              f[e].views.map((r) =>
                (function (r) {
          ...
          f[e].pageLoad &&
            (a.pageLoad = (function (e) {
              let t;
              const n = c(Ho(Ho({}, e), {}, { name: s }), [
                  function (e, n) {
                    return (t = n.trace), n;
                  },
                  $i,
                ]),
                r = { options: _(n.map((e) => e.options)), trace: t },
                o = le(
                  n.reduce(
                    (e, t) => (
      ...
      const b = [
          (function (e) {
            ...
            return (
              ...
              function (e, r) {
                const o = e.meta || {},
                  i = [ri, oi, ii, ci, ui, si, ai, fi, li, di, pi, hi].reduce(
                    (e, n) => (F(n, t) && Ce(o[n]) && (e[n] = o[n]), e),
                    {}
                  ),
                  c = r.options.map((e) =>
                    Ho(Ho({}, e), {}, { responseTokens: Ho(Ho({}, i), n) })
                  );
                return Ho(Ho({}, r), {}, { options: c });
              }
            );
          })(n, c),
          Ji,
        ...
        w = Re({
          ...
          prefetch: (function (e) {
            return y("prefetch", [Hi, ...e]);
          })(b),
        });
      var S;
      return (
        v.sendNotifications(),
        o.debug("LD.DecisionProvider", f, w),
        Promise.resolve(w)
      );
    }
    const tc = [
    ...
    function oc(e) {
      ...
      return {
        deobfuscate: function (e) {
          ...
          if (1 !== r.version) throw new Error(Ko);
          return (function (e, r) {
            let o = {};
    ...
    function ic(e, t) {
      const n = Se(e.logger),
        ...
        o = oc(e);
      const i =
          K(e.pollingInterval) && 0 === e.pollingInterval
            ? 0
            : Math.max(3e5, K(e.pollingInterval) ? e.pollingInterval : 3e5),
        c = Ge(e.fetchApi);
      let u,
        s,
        a = !1;
      ...
      let l,
        ...
        p = 0;
      const h = xi(e),
        m = q(e.artifactFormat)
          ? e.artifactFormat
          : (function (e) {
              return null != e.match(Qo) ? "bin" : "json";
            })(h),
        g = (function (e) {
          let t =
              arguments.length > 1 && void 0 !== arguments[1]
      ...
      function v(e) {
        ...
        return (
          ...
          l && !De() && qe() && (i["If-None-Match"] = l),
          et.timeStart("artifactDownloaded_fetch"),
          g(e, { headers: i, cache: "default" })
            .then((e) => {
              const i = et.timeEnd("artifactDownloaded_fetch");
              et.clearTiming("artifactDownloaded_fetch"),
                n.debug(
              ...
              return (
                ...
                304 === e.status && d
                  ...
                  ? (function (e) {
                      return "bin" === m
                        ? (et.timeStart("deobfuscate_total"),
                          e
                            .arrayBuffer()
                            .then((e) =>
                              o
                                .deobfuscate(e)
                                .then(
                                  (e) => (et.timeEnd("deobfuscate_total"), e)
                                )
                            ))
                        : (et.timeStart("artifactDownloaded_read_JSON"),
                          e
                            .json()
                            .then(
                              (e) => (
                                et.timeEnd("artifactDownloaded_read_JSON"), e
                              )
                            ));
                    })(e).then((t) => {
                      ...
                      return (
                        ...
                        (function (e) {
                          ...
                          r("artifactDownloadSucceeded", {
                            ...
                            le(f).forEach((t) => t(e));
                        })(t, ((o = e.headers), nc((e) => o.get(e)))),
                        et.timeEnd("artifactDownloaded_total"),
                        t
                      );
                    })
                  : void 0
      ...
      return (et.timeStart("artifactGetInitial"),
      w(e.artifactPayload) ? Promise.resolve(e.artifactPayload) : v(h))
        .then((t) => {
          ...
          const n = (function (e, t, n, r, o) {
            ...
            return {
              ...
              toJSON: function () {
                return Ho(
                  {
                    artifactLocation: w(t) ? Wo : e,
                    pollingInterval: n,
                    pollingHalted: r,
                    artifactVersion: Ce(i) ? i.version : Yo,
          ...
          return (
            y((e) => n.provideNewArtifact(e)),
            {
              ...
              stopPolling: () => (
                Ce(u) && (clearTimeout(u), (u = void 0)), void (a = !0)
              ),
      ...
      function i(t) {
        ...
        return ke(o)
          ...
          ? (function (e, t, n) {
                ...
                return function () {
                  let t =
                    arguments.length > 0 && void 0 !== arguments[0]
                      ...
                      : {};
                  const i = Ho({}, t);
                  ("unknownIpAddress" !== t.ipAddress && Fe(t.ipAddress)) ||
                    delete i.ipAddress;
                  const c = wi(e);
                  if (
                    r &&
              ...
              i = c;
              const u = Ho(Ho({}, t), {}, { request: i }),
                s = (function (e, t, n) {
                  const r = e.client,
                    { sessionId: o, request: i } = t,
                    c = Ce(i.trace),
                    [u, s] =
                      Ce(i.id) && q(i.id.tntId)
                        ? i.id.tntId.split(".")
                        : [void 0, void 0],
                    a = {
                      visitorId: Ho(
                    ...
                    wrap: function (e) {
                      if (c)
                        return {
                          ...
                          artifact: n,
                          profile: a,
                          request: Ho({ sessionId: o }, e.request),
              ...
              return ec(e, u, Ci(i), o, n, s);
            })
          : Promise.reject(new Error(Jo(o.version, 1)));
      }
      function c() {
        return Ce(o);
      }
      return ic(Ho(Ho({}, e), {}, { logger: n }), t).then((e) => {
        if (((r = e), (o = r.getArtifact()), ke(o))) throw new Error($o);
        return (
          r.subscribe((e) => {
            o = e;
          }),
    ...
    function dc(e, t, n) {
      ...
      const { headerKeys: a, headerEntries: f, headersObj: l } = lc(t),
        d = () => ({
          ok: 2 == ((r / 100) | 0),
          statusText: o,
          status: r,
    ...
    const pc = void 0 !== Et && "function" == typeof Et.fetch;
    const hc = /^tgt:.+/i,
      mc = (e) => hc.test(e);
    function gc() {
      try {
    ...
    const yc = /rules\.(json|txt)$/i,
      bc = /(application\/json)|(text\/)/i,
      wc = pc ? (e, t, n) => new Response(new Blob([n], { headers: t })) : dc,
      xc = (e) => e && e.match(bc),
      Sc = gc();
    function Ec(e) {
      return "tgt:" + Xe(e) + ":h";
    ...
    function Tc(e) {
      if (!Sc) return;
      const t = {
        headers: localStorage.getItem(Ec(e)),
        body: localStorage.getItem(Ac(e)),
      };
    ...
    function Oc(e) {
      return function (t, n) {
        if (!((e) => e.match(yc))(t)) return e(t, n);
        const r = Tc(t);
        function o() {
          let r =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          return e(t, Ho(Ho({}, n), r)).then(
            (e) => (xc(e.headers.get("Content-Type")) && Ic(t, e), e)
          );
        }
        return Ce(r)
          ? (qn(() => {
            ...
            Vn(wc(t, JSON.parse(r.headers), r.body)))
          : o();
      };
    }
    const kc = (e) => (t) => t[e],
      ...
      Dc = (e) => e.status === vt,
      qc = (e) => "actions" === e.type,
      Mc = (e) => "redirect" === e.type,
      jc = Pc(_c),
      Lc = Pc(Nc),
      Rc = kc("options"),
      Fc = kc(at),
      Vc = kc("eventToken"),
      Uc = kc("responseTokens"),
      Hc = (e) => G(e.name),
      Bc = (e) => w(e) && Hc(e),
      zc = (e) => w(e) && Hc(e) && ((e) => !m(e.index))(e),
      $c = (e) => w(e) && Hc(e),
      Jc = kc("data"),
      Gc = N([Jc, _c]);
    function Kc(e, t) {
      return { status: bt, type: e, data: t };
    }
    function Zc(e, t) {
      return { status: vt, type: e, data: t };
    }
    function Wc(e) {
      return w(e);
    }
    function Xc(e) {
      return !!Wc(e) && G(e.eventToken);
    }
    function Yc(e) {
      return !H(e) && !J(e.type) && G(e.eventToken);
    }
    function Qc(e) {
      return !!Yc(e) && G(e.selector);
    }
    function eu(e, t) {
    ...
    function hu(e) {
      ...
      return w(n) && H(Object.keys(n)) ? { ipAddress: "unknownIpAddress" } : n;
    }
    function mu(e, t, n) {
      const r = Do(Ao(e.globalMboxName)),
        o = {
          client: e.clientCode,
          organizationId: e.imsOrgId,
          pollingInterval: ou(e),
          propertyToken: r,
          environment: uu(e),
          cdnEnvironment: su(e),
          cdnBasePath: fu(e),
          telemetryEnabled: au(e),
          eventEmitter: pu,
          logger: vn,
          fetchApi: Oc(x(n) ? n : Ge(x(Et.fetch) ? Et.fetch : je)),
      ...
      return Vn(
        Ce(i)
          ? Ho(Ho({}, o), {}, { artifactPayload: i })
          : Ho(
              Ho({}, o),
              {},
              { artifactFormat: cu(e), artifactLocation: iu(e) }
            )
      );
    }
    function gu(e, t) {
      return (function (e) {
        ...
        ? (function (e) {
            if (!Sc) return e;
            if (Ce(Tc(xi(e))) || Ce(e.artifactPayload)) return e;
            throw (
              (qn(() => {
                setTimeout(() => ic(e, window.__target_telemetry), 1e3);
              }),
              new Error(dt))
            );
          })(t)
    ...
    function wu(e) {
      return (
        ...
        e.endpoint +
        "?" +
        $t({ client: e.clientCode, sessionId: Yn(), version: e.version })
      );
    }
    function xu(e, t, n) {
      const r = Nt(),
    ...
    function Tu() {
      const { documentElement: e } = St;
      return { width: e.clientWidth, height: e.clientHeight };
    }
    function Iu() {
      const { location: e } = Et;
      return { host: e.hostname, webGLRenderer: ko() };
    }
    function Ou() {
      const { location: e } = Et;
      return { url: e.href, referringUrl: St.referrer };
    }
    function ku(e) {
      const {
          id: t,
    ...
    function _u(e, t) {
      ...
      return (
        ...
        H(e.analytics) || (n.analytics = e.analytics),
        n
      );
    }
    function Nu(e, t) {
      const n = {},
        r = h({}, Fo(t), Fo(e.parameters || {})),
        o = h({}, Vo(t), Vo(e.profileParameters || {}, !1)),
        i = h(
          {},
          (function (e) {
            const t = {},
    ...
    function Pu(e, t) {
      ...
      const r = Nt(),
        ...
        a = Nu(e, s);
      return (
        m(i) || (a.index = i), G(c) && (a.name = c), H(u) || (a.address = u), a
      );
    }
    function Du(e, t, n) {
      const { prefetch: r = {} } = e,
      ...
      if (H(r)) return o;
      const { mboxes: i } = r;
      m(i) || !g(i) || H(i) || (o.mboxes = re((e) => Pu(e, t, n), i));
      const { views: c } = r;
      return (
        m(c) ||
          !g(c) ||
    ...
    function qu(e, t) {
      ...
      const n = Nt(),
        ...
        d = {};
      return (
        m(s) ? (d.logging = n.analyticsLogging) : (d.logging = s),
    ...
    function Lu(e, t, n, r) {
      ...
      return lu(e, t)
        ? du(e)
            .then(() =>
              (function (e) {
                return vu().then((t) => t.hasRemoteDependency(e));
              })(n)
            )
            .then((e) =>
              o === ye && e.remoteNeeded
                      ...
                      (n) => (
                        ...
                        n
                          ...
                          .then((t) => {
                            ...
                            return (
                              Et.__target_telemetry.addDeliveryRequestEntry(
                                e,
                                { execution: n, parsing: t.parsingTime },
                                t.status,
                                ge
                              ),
                              h(t, { decisioningMethod: ge })
                            );
                          })
                      )
                    );
    ...
    function Ru(e, t, n) {
      ...
      return (
        ...
        Lu(r, e, t, n).then(
          (e) => (
            gn("response", e), xn({ response: e }), { request: t, response: e }
          )
        )
      );
    }
    ...
    function Bu(e) {
      const { response: t } = e,
        ...
        { mboxes: u = [], views: s = [] } = r;
      return Hu(i), P(Hu, c), P(Hu, u), P(Hu, s), P(Hu, o), e;
    }
    function zu(e) {
      const t = e.queryKey,
        n = t.adobe_mc_sdid;
    ...
    function os(e) {
      ...
      switch (t) {
        ...
        case "customCode":
          return (function (e) {
            return rs(e) ? (q(e[at]) ? e : (gn(mt, e), null)) : null;
          })(e);
        case "setAttribute":
          return (function (e) {
            return rs(e)
              ? w(e[at])
                ? e
                : (gn("Action has no attributes", e), null)
              : null;
          })(e);
        case "setImageSource":
          return (function (e) {
            return rs(e)
              ? q(e[at])
                ? e
                : (gn("Action has no image url", e), null)
              : null;
          })(e);
        case "setStyle":
          return (function (e) {
            return rs(e)
              ? w(e[at])
                ? e
                : (gn("Action has no CSS properties", e), null)
              : null;
          })(e);
        case "resize":
          return (function (e) {
            return rs(e)
              ? w(e[at])
                ? e
                : (gn("Action has no height or width", e), null)
              : null;
          })(e);
        case "move":
          return (function (e) {
            return rs(e)
              ? w(e[at])
                ? e
                : (gn("Action has no left, top or position", e), null)
              : null;
          })(e);
        case "remove":
          return (function (e) {
        ...
        case "rearrange":
          return (function (e) {
            return rs(e)
              ? w(e[at])
                ? e
                : (gn("Action has no from or to", e), null)
              : null;
          })(e);
        case "redirect":
          return (function (e) {
        ...
        case "redirect":
          return Vn(
            (function (e) {
              ...
              const n = h({}, e);
              return (n.content = Gu(t, {})), n;
            })(e)
          );
        case "dynamic":
          return (function (e) {
            const { content: t } = e;
            return Wu(Xu(t, {}, Nt().timeout))
              .then(Yu)
              ["catch"](() => null);
          })(e);
        case "actions":
    ...
    function ps(e) {
      ...
      return Hn([ls(r, Wc), ds(o, Yc)]).then((e) => as(i, e));
    }
    function hs(e, t) {
      const {
          index: n,
      ...
      return m(s) || ss(a, s), Hn([ls(c, Xc), ds(u, Yc)]).then((e) => as(a, e));
    }
    function ms(e, t) {
      ...
      return m(u) || ss(s, u), Hn([ls(i, Xc), ds(c, Qc)]).then((e) => as(s, e));
    }
    function gs(e) {
    ...
    function vs(e) {
      ...
      return (
        ...
        H(f) || (s.prefetch = f),
        H(c) || (s.meta = c),
        H(u) || (s.notifications = u),
        s
      );
    }
    function ys(e) {
      const t = N([Bu, Vu, Uu])(e),
        n = (function (e) {
          const { response: t } = e,
            { execute: n } = t;
          ...
          const { analytics: o, options: i, metrics: c } = r,
            u = { analytics: o };
          return Hn([ls(i, Wc), ds(c, Qc)]).then((e) => as(u, e));
        })(t),
        r = (function (e) {
          const { response: t } = e,
            { execute: n } = t;
          if (!w(n)) return Vn([]);
          const { mboxes: r } = n;
          return !g(r) || H(r) ? Vn([]) : Hn(re(ps, C(Bc, r))).then(jc);
        })(t),
        o = (function (e) {
        ...
        u = (function (e) {
          const { response: t } = e,
            ...
            i = {};
          return (
            w(n) && (i.remoteMboxes = n),
            w(r) && (i.remoteViews = r),
            q(o) && (i.decisioningMethod = o),
            Vn(i)
          );
        })(t),
        s = (function (e) {
          const { response: t } = e,
            { notifications: n } = t;
          return g(n) ? Hn(re(gs, n)).then(jc) : Vn([]);
        })(t);
      return Hn([n, r, o, i, c, u, s]).then(vs);
    }
    function bs(e) {
      return !H(cs(e));
    }
    ...
    function xs(e) {
      ...
      return (
        H(n) || (t.analyticsDetails = n),
        gn("request succeeded", e),
        cr(t, bs(e)),
        Vn(e)
      );
    }
        ...
        ju(i, o)
          ...
          .then((e) =>
            (function (e, t) {
              const n = ws(t);
              return (
                (n.mbox = e), gn("request succeeded", t), cr(n, bs(t)), Vn(t)
              );
            })(n, e)
          )
          ["catch"]((e) =>
            (function (e, t) {
              return mn("request failed", t), ur({ mbox: e, error: t }), Un(t);
            })(n, e)
          )
      );
    }
    function Es(e) {
      ...
      return (
        ...
        ju(r, {})
          ...
          ["catch"]((e) =>
            (function (e) {
              return mn("request failed", e), ur({ error: e }), Un(e);
            })(e)
          )
      );
    }
    ...
    function Ns(e, t, n) {
      return Fn((r, o) => {
        ...
        de(() => {
          ...
          i.observe(St, { childList: !0, subtree: !0 });
      });
    }
    function Ps() {
    ...
    function js(e) {
      return Is("data-at-src", e);
    }
    function Ls(e) {
      return G(Is("data-at-src", e));
    }
    function Rs(e) {
      return P((e) => Cs(lt, "data-at-src", e), R(Er("img", e))), e;
    }
    function Fs(e) {
      return P((e) => Cs("data-at-src", lt, e), R(Er("img", e))), e;
    }
    function Vs(e) {
      return gn("Loading image", e), Is(lt, Os(lt, e, qn("<img/>")));
    }
    function Us(e) {
      const t = C(Ls, R(Er("img", e)));
      return H(t) || P(Vs, re(js, t)), e;
    }
    function Hs(e) {
      const t = Is(lt, e);
      return G(t) ? t : null;
    ...
    function Bs(e, t) {
      return mn("Unexpected error", t), xn({ action: e, error: t }), e;
    }
    function zs(e, t) {
      const n = br(t[ft]),
        r = (function (e) {
        ...
        o = (function (e) {
          return C(G, re(Hs, R(Er("script", e))));
        })(r);
      let i;
      try {
        i = Vn(e(n, r));
              ...
              (function (e) {
                return ue(
                  (e, t) =>
                    e.then(
                      () => (
                        gn("Script load", t), xn({ remoteScript: t }), hr(t)
                      )
                    ),
                  Vn(),
                  e
          ...
          ? ((t[st] = "appendHtml"),
            (t[at] = (function (e) {
              return te(
                "",
                ue(
                  (e, t) => (e.push(Br(xr(t))), e),
                  [],
                  R(Er("script,link,style", xr(e)))
                )
              );
            })(n)),
            t)
    ...
    function na(e) {
      const t = br(e[ft]),
        ...
        o = Number(n.to);
      if (isNaN(r) && isNaN(o))
        return gn('Rearrange has incorrect "from" and "to" indexes', e), Un(e);
      ...
      return wr(c) && wr(u)
        ? (gn("Rendering action", e),
          ...
          r < o ? Vr(c, u) : Ur(c, u),
          Vn(e))
        : (gn("Rearrange elements are missing", e), Un(e));
    }
    function ra(e) {
      const t = $s(e);
      switch (t[st]) {
        case "setHtml":
          return (function (e) {
            return gn("Rendering action", e), zs(Gs, e);
          })(t);
        case "setText":
          return Ks(t);
        case "appendHtml":
          return (function (e) {
            return gn("Rendering action", e), zs(Zs, e);
          })(t);
        case "prependHtml":
          return (function (e) {
            return gn("Rendering action", e), zs(Ws, e);
          })(t);
        case "replaceHtml":
          return (function (e) {
            return gn("Rendering action", e), zs(Xs, e);
          })(t);
        case "insertBefore":
          return (function (e) {
            return gn("Rendering action", e), zs(Ys, e);
          })(t);
        case "insertAfter":
          return (function (e) {
            return gn("Rendering action", e), zs(Qs, e);
          })(t);
        case "customCode":
          return (function (e) {
            return gn("Rendering action", e), zs(ea, e);
          })(t);
        case "setAttribute":
          return (function (e) {
            const t = e[at],
        ...
        case "remove":
          return (function (e) {
            const t = br(e[ft]);
            return gn("Rendering action", e), xn({ action: e }), Fr(t), Vn(e);
          })(t);
        case "rearrange":
          return na(t);
        default:
    ...
    function ca(e) {
      if (!oa(e)) return void ia(e);
      const t = e[ft];
      !(function (e) {
        return "trackClick" === e[st] || "signalClick" === e[st];
      })(e)
        ? (As("at-element-marker", t), ia(e))
        : As("at-element-click-tracking", t);
    }
    function ua(e) {
      return (function (e) {
        const { key: t } = e;
        ...
        const n = Is("at-action-key", e[ft]);
        return n !== t || (n === t && !e.page);
      })(e)
        ? ra(e)
            .then(
              () => (
                gn("Action rendered successfully", e),
                xn({ action: e }),
                (function (e) {
                  const { key: t } = e;
                  if (J(t)) return;
                  if (!oa(e)) return;
                  Os("at-action-key", t, e[ft]);
                })(e),
                ca(e),
                e
              )
            ...
            ["catch"]((t) => {
              mn("Unexpected error", t), xn({ action: e, error: t }), ca(e);
              const n = h({}, e);
              return (n[vt] = !0), n;
            })
        : (ca(e), e);
    ...
    function Ea(e, t, n) {
      ...
      if (H(r)) return o;
      const { mboxes: i } = r;
      m(i) || !g(i) || H(i) || (o.mboxes = re((e) => Sa(e, t, n), i));
      const { views: c } = r;
      return (
        m(c) ||
          !g(c) ||
    ...
    function Aa(e, t, n) {
      ...
      return (
        ...
        H(v) || (b.prefetch = v),
        H(y) || (b.notifications = y),
        (b = Et.__target_telemetry.addTelemetryToDeliveryRequest(b)),
        b
      );
    }
    function Ta(e, t, n) {
    ...
    function Pa(e) {
      const t = wu(Nt());
      return (function (e, t) {
        return "navigator" in (n = Et) && "sendBeacon" in n.navigator
          ? (function (e, t, n) {
        ...
        ? (gn("Beacon data sent", t, e), !0)
        : (mn("Beacon data sent failed", t, e), !1);
    }
    function Da(e, t, n) {
      const r = Ao(Nt().globalMboxName),
        o = Na(xa({}, r), t, [n]),
        i = _a(ut(), r, [o]);
      gn("Event handler notification", e, o),
        xn({ source: e, event: t, request: i }),
        Pa(i);
    }
    function qa(e, t, n) {
      const r = Ao(e),
      ...
      o.mbox = { name: e };
      const i = _a(ut(), r, [o]);
      gn("Mbox event handler notification", e, o),
        xn({ mbox: e, event: t, request: i }),
        Pa(i);
    }
    function Ma(e) {
      const t = Nt().globalMboxName,
      ...
      if (
        ...
        return;
      const o = _a(t, {}, n);
      gn("Mboxes rendered notification", n),
        xn({ source: "prefetchMboxes", event: "rendered", request: o }),
        Pa(o);
    }
    function ja(e, t, n) {
      const r = Ao(Nt().globalMboxName),
      ...
      o.view = { name: e };
      const i = _a(ut(), r, [o]);
      gn("View event handler notification", e, o),
        xn({ view: e, event: t, request: i }),
        Pa(i);
    }
    function La(e) {
      const { viewName: t, impressionId: n } = e,
        r = Ao(Nt().globalMboxName),
        o = Na(xa({}, r), xt, []);
      (o.view = { name: t }),
        gn("View triggered notification", t),
        (function (e, t, n) {
          return Ia(Ca(e), t).then((e) => ((e.notifications = n), e));
        })(t, r, [o]).then((e) => {
          (e.impressionId = n),
            xn({ view: t, event: "triggered", request: e }),
            Pa(e);
        });
    }
    function Ra(e) {
      ...
      (u.impressionId = i),
        gn("View rendered notification", o, r),
        xn({ view: o, event: "rendered", request: u }),
        Pa(u);
    }
    const Fa = {},
      Va = kc("metrics"),
    ...
    function za(e, t, n, r) {
      const { type: o, selector: i, eventToken: c } = n,
        ...
        s = () => r(e, o, c);
      !(function (e, t) {
        "click" === e && As("at-element-click-tracking", t);
      })(o, i),
        t
          ? (function (e, t) {
              return !m(Fa[e]) && !m(Fa[e][t]);
            })(e, u) ||
            (Ba(e, o, i),
            (function (e, t, n) {
              (Fa[e] = Fa[e] || {}), (Fa[e][t] = n);
    ...
    function $a(e, t, n, r) {
      return (function (e) {
        return Ms(e[ft])
          ...
          ["catch"](
            () => (
              mn("metric element not found", e),
              xn({ metric: e, message: "metric element not found" }),
              e
            )
          );
      })(n).then((n) => {
    ...
    function Ja(e, t, n, r) {
      return Hn(re((n) => $a(e, t, n, r), n))
        .then(Ua)
        ["catch"](Ha);
    }
    function Ga(e) {
      const { name: t } = e;
      return Ja(t, !1, Va(e), qa);
    }
    function Ka(e) {
      const { name: t } = e;
      return Ja(t, !0, Va(e), ja);
    }
    function Za(e) {
      return Ja("pageLoadMetrics", !1, Va(e), Da);
    }
    function Wa(e) {
      return Ja("prefetchMetrics", !1, Va(e), Da);
    }
    const Xa = kc(at),
      Ya = kc("cssSelector"),
      Qa = (e) => Zc("render", e),
    ...
    function cf(e, t, n) {
      ...
      return (function (e) {
        return Hn(re(aa, e)).then(sa);
      })(
        (function (e, t, n) {
          return re((e) => h({ key: t, page: n }, e), C(of, e));
        })(i, t, n)
      )
        .then(() => Kc("render", { eventToken: r, responseTokens: o }))
        ["catch"](Qa);
    }
    function uf(e) {
    ...
    function sf(e, t) {
      return re(e, C(uf, Rc(t)));
    }
    function af(e, t, n) {
      const r = { status: bt, [e]: t },
        o = re(Jc, C(Dc, n)),
        i = {};
      return H(o) || ((r.status = vt), (i.errors = o)), H(i) || (r.data = i), r;
    }
    function ff(e, t, n) {
      return Hn(sf((e) => cf(e, !0), e))
        .then(t)
        .then((t) => (n(e), t));
    }
    function lf(e, t, n, r) {
      const { name: o } = t;
      return Hn(sf((e) => cf(e, o, n), t))
        .then((n) =>
          (function (e, t, n) {
            const r = { status: bt, [e]: t },
              o = re(Jc, C(Dc, n)),
              ...
              s = {};
            return (
              H(o) || ((r.status = vt), (s.errors = o)),
              H(c) || (s.eventTokens = c),
              H(u) || (s.responseTokens = u),
              H(s) || (r.data = s),
              r
            );
          })(e, t, n)
    ...
    function df(e) {
      return ff(e, (t) => af("mbox", e, t), Ga);
    }
    function pf(e) {
      return lf("mbox", e, !0, Ga);
    }
    function hf(e) {
      tf(rf(e));
    }
    ...
    function gf(e) {
      tf(rf(e)), wr("#at-views") && Fr("#at-views");
    }
    const vf = new fc();
    function yf(e, t) {
      !(function (e, t, n) {
    ...
    function xf(e) {
      ...
      P((e) => {
        switch (e.action) {
          ...
          case "setJson":
            H(e.content) ||
              P((e) => n.push({ type: "json", content: e }), e.content);
            break;
          case "setText":
            o.push(
              (function (e) {
        ...
        : (function (e, t) {
            ...
            P((e) => {
              switch (e.action) {
                ...
                case "setJson":
                  H(e.content) ||
                    P((e) => r.push({ type: "json", content: e }), e.content);
                  break;
                case "redirect":
                  r.push(wf(e));
                  break;
    ...
    function kf(e) {
      if (m(e)) return [null];
      const t = re(Af, [e]);
      return Ef(t) && mn("Page load rendering failed", e), t;
    }
    function Cf(e) {
      if (m(e)) return [null];
      const t = re(Tf, e);
      return Ef(t) && mn("Mboxes rendering failed", e), t;
    }
    function _f(e) {
      let t =
      ...
      if (m(e)) return [null];
      const n = re(Tf, e);
      return Ef(n) && mn("Mboxes rendering failed", e), t(e), n;
    }
    function Nf(e) {
      let t =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Ra;
      if (m(e)) return [null];
      const n = re(If, [e]);
      Ef(n) && mn("View rendering failed", e);
      const { view: r } = e;
    ...
    function Pf(e) {
      if (m(e)) return [null];
      const t = re(Of, [e]);
      return Ef(t) && mn("Prefetch rendering failed", e), t;
    }
    function Df(e) {
      const t = _([kf(e[0]), Cf(e[1]), _f(e[2]), Pf(e[3])]),
        n = C(_c, t),
        r = C(Dc, n);
    ...
    function Ff(e) {
      ...
      H(r)
        ...
        : t.push(
            (function (e) {
              return ff(e, (t) => af("pageLoad", e, t), Za);
            })(r)
          ),
        H(o)
          ? t.push(Vn(null))
      ...
      return (
        ...
        g(u) && !H(u)
          ? t.push(
              (function (e) {
                return Hn([Wa(e)]).then(af);
              })(i)
            )
          : t.push(Vn(null)),
        Kr(),
        Hn(t).then(Df)["catch"](qf)
      );
    }
    function Vf(e, t) {
    ...
    function zf(e) {
      ...
      if (Bf(r))
        return gn(gt), Hf(n), Kr(), lr({}), yf("no-offers-event"), Vn();
      const o = Lf(n, r),
        i = cs(o);
      if (!H(i)) {
        const { url: e } = i;
        return (
          gn("Redirect action", i),
          dr({ url: e }),
          yf("redirect-offer-event"),
          Vf(Et, e),
          Vn()
        );
      }
    ...
    function Kf(e) {
      ...
      gn($f, "Using server state"), xn({ source: $f, serverState: t });
    ...
    function Zf() {
      !(function e(t, n) {
        ...
        lu(t) &&
          ...
          (nu = mu(t, n, r)
            .then((e) => gu(t, e))
            .then((e) => uc(e, Et.__target_telemetry))
            .then((e) => e)
            ["catch"]((o) => {
              throw (
                (eu(o, dt) &&
                  tu.once("artifactDownloadSucceeded", (o) =>
                    e(
                      Ho(Ho({}, t), {}, { artifactPayload: o.artifactPayload }),
                      n,
                      r
                    )
                  ),
    ...
    function Wf() {
      if (!sn() && !fn()) return mn($f, pt), void xn({ source: $f, error: pt });
      const e = Nt();
      if (
        (function (e) {
      ...
      if (!t && !n)
        return (
          gn($f, "Page load disabled"),
          void xn({ source: $f, error: "Page load disabled" })
        );
      Gr();
      const r = {};
      if (t) {
      ...
      const o = e.timeout;
      gn($f, "request", r), xn({ source: $f, request: r });
      const i = { request: r, timeout: o };
      Jn() && !Gn()
        ? Zn()
            .then(() => {
              Es(i).then(Gf)["catch"](Jf);
            })
            ["catch"](Jf)
        : Es(i).then(Gf)["catch"](Jf);
    }
    ...
    function Qf(e) {
      return J(e)
        ? Yf("mbox option is required")
        : e.length > 250
        ? Yf("mbox option is too long")
        : Xf();
    }
    function el(e) {
      ...
      P((e) => {
        ...
        switch (o) {
          ...
          case "redirect":
            ...
            break;
          case "actions":
            r.push.apply(r, tl(e.content));
        }
      }, o),
        H(t) || r.push({ action: "setContent", content: t.join("") }),
    ...
    function il(e, t) {
      const n = (function (e) {
        const { execute: t = {} } = e,
          ...
          { mboxes: r = [] } = t,
          o = [];
        return o.push.apply(o, rl(n)), o.push.apply(o, _(re(rl, r))), o;
      })(t);
      e[bt](n);
    }
    function cl(e) {
      const t = (function (e) {
          ...
          return t[yt]
            ? x(e[bt])
              ? x(e[vt])
                ? Xf()
                : Yf("error option is required")
              : Yf("success option is required")
            : t;
        })(e),
        n = t[vt];
      if (!t[yt])
        return mn(ol, n), void xn({ source: ol, options: e, error: n });
      if (!sn() && !fn())
        return (
          de(e[vt]("warning", pt)),
          mn(ol, pt),
          void xn({ source: ol, options: e, error: pt })
        );
      const r = (t) => il(e, t),
        o = (t) =>
          (function (e, t) {
    ...
    function sl(e) {
      const t = (function (e) {
          if (!w(e)) return Yf(ht);
          const { request: t } = e;
          if (!w(t)) return Yf("request option is required");
          const { execute: n, prefetch: r } = t;
          return w(n) || w(r) ? Xf() : Yf("execute or prefetch is required");
        })(e),
        n = t[vt];
      return t[yt]
        ? sn() || fn()
          ? (gn(ul, e),
            xn({ source: ul, options: e }),
            !Jn() || Gn() ? Es(e) : Zn().then(() => Es(e)))
          : (mn(ul, pt),
            xn({ source: ul, options: e, error: pt }),
            Un(new Error(pt)))
        : (mn(ul, n), xn({ source: ul, options: e, error: n }), Un(t));
    }
    const al = "[applyOffer()]";
    function fl(e) {
      const t = Uf(e.selector),
        n = M(t);
      et.timeStart(n);
      const r = (function (e) {
          if (!w(e)) return Yf(ht);
          ...
          if (!t[yt]) return t;
          const n = e.offer;
          return g(n) ? Xf() : Yf("offer option is required");
        })(e),
        o = r[vt];
      if (!r[yt])
        return (
          mn(al, e, o), xn({ source: al, options: e, error: o }), void Hf(t)
        );
      if (!sn() && !fn())
        return (
          mn(al, pt), xn({ source: al, options: e, error: pt }), void Hf(t)
        );
      (e.selector = t),
        gn(al, e),
        xn({ source: al, options: e }),
        (function (e) {
          const { mbox: t, selector: n, offer: r } = e,
            o = Nt(),
            i = t === o.globalMboxName;
          if (H(r)) return gn(gt), Hf(n), Kr(), void lr({ mbox: t });
          const c = Lf(n, Sf(t, r, i)),
            u = cs(c);
          if (!H(u)) {
            const { url: e } = u;
            return gn("Redirect action", u), dr({ url: e }), void Vf(Et, e);
          }
          sr({ mbox: t }),
            mf(c),
            Ff(c)
              .then((e) => {
                H(e) || ar({ mbox: t, execution: e });
              })
              ["catch"]((e) => fr({ error: e }));
        })(e);
    ...
    function ll(e) {
      ...
      const r = (function (e) {
          if (!w(e)) return Yf(ht);
          const { response: t } = e;
          return w(t) ? Xf() : Yf("response option is required");
        })(e),
        o = r[vt];
      return r[yt]
        ? sn() || fn()
          ? ((e.selector = t),
            gn("[applyOffers()]", e),
            xn({ source: "[applyOffers()]", options: e }),
            zf(e).then(() => {
              const e = et.timeEnd(n);
              et.clearTiming(n), window.__target_telemetry.addRenderEntry(n, e);
            }))
          : (mn("[applyOffers()]", pt),
            xn({ source: "[applyOffers()]", options: e, error: pt }),
            Hf(t),
            Un(new Error(pt)))
        : (mn("[applyOffers()]", e, o),
          xn({ source: "[applyOffers()]", options: e, error: o }),
          Hf(t),
          Un(r));
    }
    function dl(e) {
      ...
      if (!o[yt])
        return (
          mn("[sendNotifications()]", i),
          void xn({ source: "[sendNotifications()]", options: e, error: i })
        );
      if (!sn() && !fn())
        return (
          mn("[sendNotifications()]", pt),
          void xn({ source: "[sendNotifications()]", options: e, error: pt })
        );
      gn("[sendNotifications()]", e),
        xn({ source: "[sendNotifications()]", options: e });
      const { notifications: c } = r,
        u = _a(n, {}, c);
      !Jn() || Gn()
        ? Pa(u)
        : mn("[sendNotifications()]", "Adobe Target is not opted in");
    }
    const pl = "[trackEvent()]";
    function hl(e) {
      if (Jn() && !Gn())
        return (
          mn("Track event request failed", "Adobe Target is not opted in"),
          void e[vt](vt, "Adobe Target is not opted in")
        );
      !(function (e) {
        const { mbox: t, type: n = xt } = e,
          r = w(e.params) ? e.params : {},
          o = h({}, Ao(t), r),
          i = Na(xa({}, o), n, []);
        if (((i.mbox = { name: t }), Pa(_a(t, o, [i]))))
          return gn("Track event request succeeded", e), void e[bt]();
        mn("Track event request failed", e),
          e[vt]("unknown", "Track event request failed");
      })(e);
    }
    function ml(e) {
      const t = e[ft],
    ...
    function gl(e) {
      const t = (function (e) {
        ...
        n = t[vt];
      if (!t[yt])
        return mn(pl, n), void xn({ source: pl, options: e, error: n });
      const r = (function (e, t) {
        const n = t.mbox,
          r = h({}, t),
      ...
      if (!sn() && !fn())
        return (
          mn(pl, pt),
          de(r[vt]("warning", pt)),
          void xn({ source: pl, options: e, error: pt })
        );
      gn(pl, r),
        xn({ source: pl, options: r }),
        (function (e) {
          const t = e[st],
            n = e[ft];
          return G(t) && (G(n) || mr(n));
    ...
    function bl(e) {
      return (
        ...
        (function (e) {
          ...
          ["catch"]((e) => {
            mn("View rendering failed", e), fr({ error: e });
          })
      );
    }
    function wl() {
    ...
    function Sl(e, t) {
      if (!Nt().viewsEnabled)
        return void mn("[triggerView()]", "Views are not enabled");
      if (!q(e) || J(e))
        return (
          mn("[triggerView()]", "View name should be a non-empty string", e),
          void xn({
            source: "[triggerView()]",
            view: e,
      ...
      gn("[triggerView()]", n, r),
        xn({ source: "[triggerView()]", view: n, options: r }),
        (function (e) {
          vl.push(e), 0 !== yl && wl();
        })(r);
    }
    bf("cache-updated-event", xl),
      bf("no-offers-event", xl),
      bf("redirect-offer-event", xl);
    const El =
    ...
    return {
      init: function (e, t, n) {
        if (e.adobe && e.adobe.target && void 0 !== e.adobe.target.getOffer)
          return void mn("Adobe Target has already been initialized.");
        _t(n);
        const r = Nt(),
          o = r.version;
        if (
        ...
        yn(Et, Nt(), an()),
          ...
          Zf(),
          Wf(),
          (e.adobe.target.getOffer = cl),
          (e.adobe.target.getOffers = sl),
          (e.adobe.target.applyOffer = fl),
          (e.adobe.target.applyOffers = ll),
          (e.adobe.target.sendNotifications = dl),
          (e.adobe.target.trackEvent = gl),
          (e.adobe.target.triggerView = Sl),
          (e.adobe.target.registerExtension = kl),
          (e.mboxCreate = Cl),
          (e.mboxDefine = _l),
          (e.mboxUpdate = Nl),
          (e.__target_telemetry = (function () {
            ...
            function i(e) {
              const t = {};
              return (
                e.dns && (t.dns = Je(e.dns)),
                e.tls && (t.tls = Je(e.tls)),
                e.timeToFirstByte &&
                  (t.timeToFirstByte = Je(e.timeToFirstByte)),
                e.download && (t.download = Je(e.download)),
                e.responseSize && (t.responseSize = Je(e.responseSize)),
                t
              );
            }
            function c(e) {
              const t = {};
              return (
                e.execution && (t.execution = Je(e.execution)),
                e.parsing && (t.parsing = Je(e.parsing)),
            ...
            function s(t) {
              e && u({ requestId: t.requestId, timestamp: oe() });
            }
            function a(t, n) {
              e && u({ requestId: t, timestamp: oe(), execution: n });
            }
            function f(e, t) {
              u(h(t, { requestId: e, timestamp: oe() }));
            }
            function l(t, n) {
              e && n && f(t, n);
            }
            function d(n, i, c) {
              ...
              if (!e || !i) return;
              const { requestId: s } = n,
                a = h(o(n), { decisioningMethod: u }),
                l = { mode: r(c, u), features: a },
                d = h(i, l);
              f(s, d);
            }
            function p() {
          ...
          })(r.telemetryEnabled && gc(), r.decisioningMethod, Pl())),
          (function () {
  ...
  window.adobe.target.init(window, document, {
    clientCode: "emeastage3",
    imsOrgId: "653738B3527136580A490D4C@AdobeOrg",
    serverDomain: "emeastage3.tt-stage1.omtrdc.net",
    timeout: Number("1000"),
